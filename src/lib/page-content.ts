...
const VALUE_DEFS = [
  { key: "values_hygiene", fallbackTitle: "Sahaya Uygun Keşif" },
  { key: "values_products", fallbackTitle: "Kaliteli Malzeme" },
  { key: "values_team", fallbackTitle: "Profesyonel Ekip" },
  { key: "values_personal", fallbackTitle: "Projeye Özel Çözüm" },
] as const;
...
export async function loadContactPageData(): Promise<ContactPageData> {
  ...
  return {
    ...
    formCopy: {
      cardTitle: map.contact_card_title || "Global Reklam",
      ...
      whatsappPrefill:
        ...
        "Merhaba, ücretsiz keşif / teklif için yazıyorum.",
