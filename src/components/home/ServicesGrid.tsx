      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-8">
          <div className="max-w-xl">
            ...
            <EditableText
              ...
              value={title || "Tabela ve Reklam Çözümlerimiz"}
              as="h2"
              block
            ...
            <EditableText
              ...
              value={
                intro ||
                "Tabela ve reklam sektöründe geniş ürün yelpazemizle markanıza değer katıyoruz."
              }
              as="p"
              block
              multiline
        ...
        >
          {SERVICE_GRID.map((service) => {
            const Icon = iconMap[service.icon] || Signpost;
            return (
              <SiteLink
                key={service.slug}
