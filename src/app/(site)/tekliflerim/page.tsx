...
export default function TekliflerimPage() {
  ...
  async function requestMount(e: React.FormEvent) {
    ...
    try {
      ...
      setMountMsg("Montaj talebi kaydedildi. Ekibimiz teyit için arayacak.");
      setResult((r) =>
        r
          ? {
              ...r,
    ...
    <section className="py-16 lg:py-24">
      <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-muted text-sm mb-8">
          Sipariş numaranız ve telefon numaranız ile teklif, fatura ve montaj
          durumunuzu yönetin.
        </p>
