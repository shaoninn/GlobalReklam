    ...
    <section className="py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <PageIntro
          ...
          eyebrow={map.projects_eyebrow || "Portföy"}
          title={map.projects_title || "Gerçekleştirdiğimiz Projeler"}
          intro={
            map.projects_intro ||
        ...
        {projects.length === 0 ? (
          <EditableText
            ...
            value={map.projects_empty || "Henüz yayınlanmış proje yok."}
            as="p"
            block
            className="text-muted"
            help="Proje yokken görünen mesaj"
          />
        ) : (
