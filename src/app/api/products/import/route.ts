...
export async function GET() {
  ...
  if (rows.length === 0) {
    rows.push({
      id: "",
      name: "Örnek Kutu Harf",
      slug: "ornek-kutu-harf",
      categorySlug: "kutu-harf-sistemleri",
      categoryName: "",
      price: 5000,
  ...
  XLSX.utils.book_append_sheet(book, sheet, "Urunler");
  ...
  return new NextResponse(new Uint8Array(buffer), {
    headers: {
      ...
      "Content-Disposition": `attachment; filename="global-urunler.xlsx"`,
    },
  });
}
