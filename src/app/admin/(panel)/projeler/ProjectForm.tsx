  ...
  return (
    <form onSubmit={onSubmit} className="admin-card p-4 sm:p-6 max-w-2xl w-full">
      ...
      <AdminField
        ...
        help="Sayfa adresi için kısa kod. Örn: isikli-totem → globalreklam.com/projeler/isikli-totem. Küçük harf, tire kullanın; Türkçe karakter ve boşluk yazmayın. Başlık yazınca otomatik dolar — gerekmedikçe değiştirmeyin."
      >
        <input
          className="admin-input"
          value={slug}
      ...
      <AdminField label="Konum" help="Örn: Antalya / Çakırlar">
        <input
          className="admin-input"
          value={location}
